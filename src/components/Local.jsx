...
import NewsImg from '../assets/hero-main-bg.png'; // Make sure this path is correct
...
const newsItems = [
  {
    ...
    imageUrl: NewsImg, 
    spanFull: true, // This item will span the full width on the first row
  },
  {
    id: 2,
    title: 'Titre de l\'article',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20 ">
            ...
            <div className='md:col-span-2'>
                <div className='mb-4 flex justify-between items-center'>
                    ...
                    <a href="/news" className='text-md text-white underline'>Toutes l'actualités ></a>
                </div>
                {/* First Row with Large Image */}
                <div className="grid grid-cols-1 gap-6">
                    {newsItems.map((item, index) => (
                        <div key={item.id} className={`relative shadow-black shadow-inner bg-white h-[20vh] p-4 rounded-lg overflow-hidden ${index === 0 ? 'md:col-span-2' : 'md:col-span-1'}`}>
